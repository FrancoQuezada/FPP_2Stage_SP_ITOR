...
difference between separated CoverageLLBI and PathLLBI on actual trees
cannot by itself demonstrate stronger \emph{complete} bounds. Finite
separation, cut selection, construction time and solver interaction are
distinct sources of computational differences. On a general Reburn graph,
the complete path bound may be strictly stronger than complete coverage,
but the principal experiments optimize trees.
